...
#define  HYDROGENMASS      (2.408544e-24)
...
{
  int  TotNumPart;		/*!< total particle numbers (global value) */
  int  TotN_gas;		/*!< total gas particle number (global value) */
  ...
  double MaxEgySpec;            /*!< the minimum allowed temperature expressed as energy per unit mass */

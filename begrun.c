...
#ifdef   ISOTHERM_EQS
GAMMA        =  (1.0);     /*!< index for isothermal gas */
GAMMA_MINUS1 =  (GAMMA-1);
#endif 

#ifdef ADIABATIC
GAMMA        =  (1.4);     /*!< index for isothermal gas */
GAMMA_MINUS1 =  (GAMMA-1);
#endif
...
#ifdef SINK	
      printf("Critical number density in cgs = %g \n", All.CriticalNumberDensity);
#endif 
      printf("\n");
    }
  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      id[nt++] = DOUBLE;
	    ...
	    strcpy(tag[nt], "MaxGasTemp");
      addr[nt] = &All.MaxGasTemp;
      id[nt++] = DOUBLE;
...
/*SINK*/ 
      ...
      strcpy(tag[nt], "CriticalNumberDensity");
      addr[nt] = &All.CriticalNumberDensity;
      id[nt++] = DOUBLE;
      ...
      strcpy(tag[nt], "CriticalNumstep");
      addr[nt] = &All.CriticalNumstep;
      id[nt++] = INT;
